@php
    ...
    if (Auth::check()) {
        $cart = Auth::user()->cart;
        $cartCount = $cart ? $cart->products->sum('pivot.quantity') : 0;
...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <!-- WISHLIST LINK SA IKONICOM I COUNTER-OM -->
                    @auth
                    <x-nav-link :href="route('wishlist.index')" :active="request()->routeIs('wishlist.index')">
                        <div class="flex items-center">
                            ...
                            {{ __('Wishlist') }}
                            @if($wishlistCount > 0)
                                <span class="ml-1 bg-pink-500 text-white text-xs font-bold rounded-full h-5 w-5 flex items-center justify-center">
                                    {{ $wishlistCount }}
                                </span>
                            @endif
                        </div>
                    ...
                    <!-- CART LINK SA IKONICOM I COUNTER-OM -->
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <!-- WISHLIST u dropdown meniju -->
                        <x-dropdown-link :href="route('wishlist.index')">
                            <div class="flex items-center justify-between">
                                <span>{{ __('Wishlist') }}</span>
                                @if($wishlistCount > 0)
                                    <span class="ml-2 bg-pink-500 text-white text-xs font-bold rounded-full h-5 w-5 flex items-center justify-center">
                                        {{ $wishlistCount }}
                                    </span>
                                @endif
                            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <!-- MOBILE WISHLIST LINK SA IKONICOM -->
            @auth
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                ...
                <!-- WISHLIST u mobile dropdown meniju -->
